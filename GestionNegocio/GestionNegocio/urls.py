...
urlpatterns = [
    ...
    path("vistaCategoria/", views.vistaCategorias),
    ...
    path("consultarProducto/<int:id>/", views.consulatarProducto),
    path("actualizarProducto/", views.actualizarProducto),
    path("elminarProducto/<int:id>/", views.eliminarProducto), 
     path('', include('appTienda.urlsApi'))
]
